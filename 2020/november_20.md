...
The month of November has seen a lot of improvements to Multicore
OCaml, especially on changes to facilitate upstreaming to stock
OCaml. A number of commits have been merged to Multicore OCaml to
better handle stack switching. With the systhreads support available
using pthreads and dune available natively, we are seeing a surge in
the number of packages that can be built for Multicore OCaml.

The lockfree and Graph500 benchmarks have been added and updated to
Sandmark respectively, and we continue to work on the tooling
aspects. Benchmarking tests are also being done on AMD, ARM and
PowerPC hardware to study the performance of the compiler. With
reference to stock OCaml, the safepoints PR has now landed for review.
...
* [ocaml-multicore/ocaml-multicore#435](https://github.com/ocaml-multicore/ocaml-multicore/pull/435)
  ...
  ![PR 435 Graph Image](images/OCaml-Multicore-PR-435-Illustration.png)
...
* [ocaml-bench/sandmark#194](https://github.com/ocaml-bench/sandmark/pull/194)
  ...
  ![PR 194 Time Image](images/OCaml-Sandmark-PR-194-Time.png)

  ![PR 194 Speedup Image](images/OCaml-Sandmark-PR-194-Speedup.png)
...
* [ocaml/ocaml#9934](https://github.com/ocaml/ocaml/pull/9934)
  ...
  ![PR 9934 Graph](images/OCaml-PR-9934-Illustration.png)
...
* [ocaml/ocaml#10039](https://github.com/ocaml/ocaml/pull/10039)
  ...
  ![PR 10039 Benchmark](images/OCaml-PR-10039-Illustration.png)
